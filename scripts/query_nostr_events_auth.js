...
/**
 * Query Nostr Events from relay with NIP-42 Authentication
 *
 * Usage: node query_nostr_events_auth.js [kind] [--since TIMESTAMP] [--relay URL]
 */
...
// Parse arguments (before keypair generation so --relay is set first)
...
console.log(
  `Querying kind ${kind} events from relay (${RELAY_URL}) with authentication...\n`
);
